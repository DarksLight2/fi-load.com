...
if (isset($_GET['delete']) > 0 && userCheck(0) == true) {
    ...
    addAdminLog($user['id'],
        "Удалил комментарий: <i>" . $com['text'] . "</i>. Пользователя: " . smallUserData($com['author'], 2));
...
<div class="col-sm mainMenu">
    ...
    <div style="float: right">
        ...
        ?>
        <a href="">
            <div class="button">Пожаловаться</div>
        </a>
    </div>
</div>
<br>
...
<form method="POST">
    <div class="mainMenu">
        <textarea name="comment" id="comment" cols="155px" rows="5"
                  style="resize: none;background: #37516c;color: white;"></textarea><br>
